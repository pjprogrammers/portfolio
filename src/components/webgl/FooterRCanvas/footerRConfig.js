...
export const FOOTER_R_SIZE_FILL = 0.55;

/**
 * Prominencia máxima de la formación estrella como fondo ambiental (0–1).
 * 0 = invisible (hero), ~0.35–0.4 = sutil por el resto del sitio.
 */
export const AMBIENT_FORMATION_MAX_PROMINENCE = 0.38;

/**
 * Fracción de partículas (0–1) que forman la figura en el estado ambiental.
 * El resto permanece en el campo orgánico, bajando la densidad dentro de la forma.
 */
export const FOOTER_R_FORMATION_FRACTION = 0.55;

/** Opacidad relativa de las partículas de campo frente a las de la figura. */
export const AMBIENT_FIELD_OPACITY = 0.3;

/**
 * Escala de starGeometry (la chispa de 4 pétalos) al espacio normalizado de la R.
 * El bounding box del pétalo (±2.55) coincide con el footprint de la estrella
 * anterior: equivale al antiguo radio de esfera (0.48) sobre el extent raw (~2.55).
 */
...
export const FOOTER_PARTICLE_GLOW_BOOST = 0.8;

/** Fuerza del halo exterior por partícula (0–1). */
export const FOOTER_PARTICLE_HALO_STRENGTH = 0.35;
