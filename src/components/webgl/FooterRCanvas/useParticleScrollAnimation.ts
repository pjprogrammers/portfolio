...
import { setupAmbientFormationTrigger } from "@/components/webgl/FooterRCanvas/ambientFormationTrigger.js";
...
function resetParticleScrollState() {
  ...
  particleScrollState.formationProminence = 0;
}
