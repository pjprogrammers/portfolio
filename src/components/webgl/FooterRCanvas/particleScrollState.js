...
export const particleScrollState = {
  ...
  rFormation: 0,
  /**
   * Prominencia de la estrella como fondo ambiental (0–1) impulsada por scroll.
   * 0 en el hero; sube a ~0.38 según la página baja. Solo afecta al tramo
   * `[data-ambient-formation]`; la R del footer no la usa.
   */
